# Solución Propuesta y Estructura del Trabajo
...
Este apartado expone de manera sucinta la estructura final del trabajo, los apartados que contiene y la información recogida en cada uno de dichos apartados.

### Metodología - Rational Unified Process (RUP)

Se utilizará RUP (Kruchten, P, 2004) como marco metodológico, es un marco de trabajo (framework) para el desarrollo de software, iterativo, incremental y centrado en la arquitectura.
